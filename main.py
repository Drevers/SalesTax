...
class Item:
    def __init__(self,price:float,amount:int,exempt:bool,imported_good:bool):
...
class TestReceipt(unittest.TestCase):
    ...
    def test_exempt_goods(self):
        ...
        book:Type[Item] = Item(12.49,1,True,False)
        cd:Type[Item] = Item(14.99,1,True,False)
        chocolate:Type[Item] = Item(0.85,1,True,False)
    ...
    def test_imported_goods(self):
        ...
        chocolate:Type[Item] = Item(10.00,1,True,True)
        perfume:Type[Item] = Item(47.50,1,False,True)
    ...
    def test_mixed_goods(self):
        ...
        perfume_imported:Type[Item] = Item(27.99,1,False,True)
        perfume:Type[Item] = Item(18.99,1,False,True)
        pills:Type[Item] = Item(9.75,1,True,False)
        chocolate:Type[Item] = Item(11.25,1,True,True)
